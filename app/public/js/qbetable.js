...
function getURLColsFromURL(allColumns) {
    var m = /c(\d+(,\d+)*)/.exec(window.location.search || "");
...
var Picker = /** @class */ (function (_super) {
    ...
    Picker.prototype.render = function () {
        ...
        return (React.createElement("header", { className: "qbeHeaderFuzzy" },
            "search:",
            React.createElement("input", { className: "searchInput", type: "text", placeholder: "search string  or add/delete column <columnname>", style: { width: "80%", textAlign: "left" }, onChange: function (e) { return onChange(e.target.value); }, value: value })));
    };
    return Picker;
}(react_1.Component));
;
...
/******/ 	__webpack_require__("./src/web/qbetable.tsx");
/******/ })()
;
