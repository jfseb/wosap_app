  ...
  render() {
    ...
    return (
      <header className="qbeHeaderFuzzy">
        search:
        <input className="searchInput" type="text" placeholder="search string  or add/delete column &lt;columnname&gt;" style={{  width : "80%", textAlign:"left"}} onChange={e => onChange(e.target.value)} value={value} />
      </header>
    );
  }
}
